...
## Installation 
We highly recommend usage of a GPU backed machine in oHerder to reproduce the figures here. CPU only based usage is not tested.  
...
To regenerate Figures 1 and 2, please use the repo labeled "compare_performance" 
...
## Figure 4 setup:
To regenerate Figure 4, please use the repo labeled "imagenet_pl"
