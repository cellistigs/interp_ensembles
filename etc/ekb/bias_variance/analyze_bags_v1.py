...
def kl_diversity(probs, labels):
    """Given probs of shape (models,samples, classes) and labels of shape (samples), generate a corresponding diversity
    measure.
...
if __name__ == "__main__":
    # %%
    datadir = "/datahd3a/ensemble_attention/trees_kelly"
    ...
    outputdir = "/data/Projects/linear_ensembles/interp_ensembles/results/biasvar/"
    output_dir = Path("/data/Projects/linear_ensembles/interp_ensembles/results/biasvar/MNIST")
