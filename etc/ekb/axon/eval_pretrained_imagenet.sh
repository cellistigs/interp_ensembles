...
# ------ set outputdirectory ------
OUTPUTDIR="/share/ctn/users/ekb2154/data/libraries/interp_ensembles/results/imagenet/logits"
mkdir -p $OUTPUTDIR
...
python /home/ekb2154/data/libraries/interp_ensembles/scripts/train_imagenet.py ${dataset_dir} --arch=${model} \
  --workers=${workers} \
  --pretrained \
  --gpu ${gpu} \
  --evaluate \
