...
plt.style.use('/data/Projects/linear_ensembles/interp_ensembles/etc/ekb/matplotlibrc')
import sys
...
datasets = ['imagenet', 'imagenetv2mf']
data_types = ['','']
dataset_ood=datasets[1]
data_type_ood=data_types[1]

print('Running ', dataset_ood, data_type_ood, 'bye')
